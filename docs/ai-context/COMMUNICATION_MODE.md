...
- Use Investigation Mode for CLI, Configuration, Analyzers / Risk Rules, Renderers / Reports, Repository scanning, Templates, Staff/POS/public flows, Context docs, Release workflow tasks.
