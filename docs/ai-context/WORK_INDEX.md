...
| General maintenance | 8 | Prepared impact suggestedCommands for v0.12 verification intelligence with structured type, scope, and confidence metadata plus regression guards. |
